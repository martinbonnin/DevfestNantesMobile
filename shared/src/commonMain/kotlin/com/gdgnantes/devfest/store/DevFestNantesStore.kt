...
import com.gdgnantes.devfest.store.graphql.toPartnersGroup
import com.gdgnantes.devfest.store.graphql.toRoom
import com.gdgnantes.devfest.store.graphql.toSession
import com.gdgnantes.devfest.store.graphql.toSpeaker
import com.gdgnantes.devfest.store.graphql.toVenue
 ...
 *
 */
class DevFestNantesStore(private val apolloClient: ApolloClient) {
    val robin = "Robin"
